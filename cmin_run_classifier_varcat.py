...
## Required parameters
flags.DEFINE_string(
	"data_dir", "../data/var_category_top4_firsttag",
	"The input data dir. Should contain the .tsv files (or other data files) "
	"for the task.")

flags.DEFINE_string(
	"bert_config_file", "../data/bert_base/chinese_L-12_H-768_A-12/bert_config_4layer.json",
	"The config json file corresponding to the pre-trained BERT model. "
	"This specifies the model architecture.")

flags.DEFINE_string("task_name", "wbmz", "The name of the task to train.")

flags.DEFINE_string("vocab_file", "../data/bert_base/chinese_L-12_H-768_A-12/vocab.txt",
					"The vocabulary file that the BERT model was trained on.")

flags.DEFINE_string(
	"output_dir", "../model_output/var_category_4layer_top4_firsttag_1",
	"The output directory where the model checkpoints will be written.")

## Other parameters

flags.DEFINE_string(
	"init_checkpoint", "../data/bert_base/chinese_L-12_H-768_A-12/bert_model.ckpt",
...
class WbmzProcessor(DataProcessor):
	...
	examples = []
	for (i, line) in enumerate(lines):
		### Congmin: why skip the first record?
		if i == 0:
			continue
		guid = "%s-%s" % (set_type, i)
