...
def create_training_instances(input_files, tokenizer, max_seq_length,
	...
	with tf.gfile.Open(input_files, "rb") as f:
			...
			for line in reader:
				...
				is_random_next = int(tokenization.convert_to_unicode(line[-1]))
				...
				if not len(tokens_a) >= 1 or not len(tokens_b) >= 1: continue
...
def main(_):
	...
	instances = create_training_instances(
			FLAGS.input_file, tokenizer, FLAGS.max_seq_length, FLAGS.dupe_factor,
