...
export DATA_DIR=../data/test_huati  #huati_material_basis_remove1class
export OUTPUT_DIR=../model_output/run_huati_material_basis_remove1class
export INIT_CKPT_DIR=$BERT_BASE_DIR #../model_output/cht_init_ckpt
